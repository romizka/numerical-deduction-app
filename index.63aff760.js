...
tasksSection.innerHTML = (0, _tasksListJs.tasksList).map((item)=>`

      <h2 class="tasks__number">Task ${(0, _tasksListJs.tasksList).indexOf(item)}</h3>
      ...
      <div class="tasks__answers">
        ...
        <fieldset>
          ...
          <div>
          <input type="radio" name='task-${(0, _tasksListJs.tasksList).indexOf(item)}' value="0" id="task-${(0, _tasksListJs.tasksList).indexOf(item)}-a"/>
          <label for="task-${(0, _tasksListJs.tasksList).indexOf(item)}-a">"${item.A}"</label>
           <input type="radio" name='task-${(0, _tasksListJs.tasksList).indexOf(item)}' value="1" id="task-${(0, _tasksListJs.tasksList).indexOf(item)}-b" />
           <label for="task-${(0, _tasksListJs.tasksList).indexOf(item)}-b">"${item.B}"</label>
          <input type="radio" name='task-${(0, _tasksListJs.tasksList).indexOf(item)}' value="0" id="task-${(0, _tasksListJs.tasksList).indexOf(item)}-c"/>
          <label for="task-${(0, _tasksListJs.tasksList).indexOf(item)}-c">"${item.C}"</label>
           <input type="radio" name='task-${(0, _tasksListJs.tasksList).indexOf(item)}' value="0" id="task-${(0, _tasksListJs.tasksList).indexOf(item)}-d"/>
           <label for="task-${(0, _tasksListJs.tasksList).indexOf(item)}-d">"${item.D}"</label>
          </div>
          </fieldset>
...
},{"./tasksList.js":"hYc5Q"}],"hYc5Q":[function(require,module,exports) {
...
},{}]},["9ZIyz","adjPd"], "adjPd", "parcelRequire7667")
