...
<li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r">
  <div class="flex items-center pl-3 bg-blue-100">
      <input id="horizontal-list-radio-license" type="radio" value="${item.answers[0].value}" name='task-${(0, _tasksListJs.tasksList).indexOf(item)}' class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500 focus:ring-2">
...
<li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r">
  <div class="flex items-center pl-3 bg-blue-100">
      <input id="horizontal-list-radio-id" type="radio" value="${item.answers[1].value}" name='task-${(0, _tasksListJs.tasksList).indexOf(item)}' class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500 focus:ring-2">
...
<li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r">
  <div class="flex items-center pl-3 bg-blue-100">
      <input id="horizontal-list-radio-millitary" type="radio" value="${item.answers[2].value}" name='task-${(0, _tasksListJs.tasksList).indexOf(item)}' class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500 focus:ring-2">
...
<li class="w-full">
  <div class="flex items-center pl-3 bg-blue-100">
      <input id="horizontal-list-radio-passport" type="radio" value="${item.answers[3].value}" name='task-${(0, _tasksListJs.tasksList).indexOf(item)}' class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500 focus:ring-2">
...
},{}]},["e11Rl","gLLPy"], "gLLPy", "parcelRequire7667")
